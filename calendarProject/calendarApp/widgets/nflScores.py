...
class NFLWidget(BaseWidget):
    name = 'nfl'
    template_name = "calendarApp/widgets/nflScores.html"
    ...
    def get_scores(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                for event in events:
                    games.append({
                        ...
                        "status": event.get("strStatus")  # "Match Finished", etc.
                    })
            ...
            return [{"error": "Unable to fetch NFL scores."}]
